  ...
  return (
    <div className="h-full w-full text-white">
      <div className="relative flex h-full w-full items-center justify-center p-6">
        ...
        <div className="absolute flex flex-col items-center justify-center px-4 sm:left-6 sm:flex-row sm:px-0">
          <div className="flex h-full flex-col items-center sm:items-start">
            ...
            <button className="mt-3 flex w-max items-center justify-center bg-white px-6 py-1 text-soft-green hover:bg-slate-100">
